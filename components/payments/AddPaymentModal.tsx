        ...
        {showDatePicker && (
          <>
            ...
            {Platform.OS === "ios" && (
              ...
              >
                <Text style={[styles.dateDoneText, { color: tint }]}>
                  {t("done")}
                </Text>
              </Pressable>
            )}
          ...
          >
            ...
            >
              <Text style={[styles.title, { color: text }]}>
                {editing ? t("editPayment") : t("logZakahPayment")}
              </Text>
              <ScrollView
              ...
              {confirmDelete ? (
                <View style={styles.confirmRow}>
                  ...
                  <View style={styles.confirmBtns}>
                    ...
                    >
                      <Text style={[styles.confirmBtnText, { color: muted }]}>
                        {t("cancel")}
                      </Text>
                    </Pressable>
                    <Pressable
                    ...
                    >
                      <Text style={[styles.confirmBtnText, { color: danger }]}>
                        {t("delete")}
                      </Text>
                    </Pressable>
                  </View>
