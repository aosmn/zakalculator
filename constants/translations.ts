export const en = {
  ...
  metalPricesDesc: 'Used to calculate the value of your gold and silver holdings',
  ...
  exchangeRateDesc: 'Convert foreign balances to {{base}} — 1 [currency] = X {{base}}',
  from: 'FROM',
  rate: 'Rate',
  select: 'Select',
  addRate: 'Add Rate',
  ...
  deletePersonMsg: 'Their holdings and payment history will be removed. This cannot be undone.',
...
export const ar: typeof en = {
  ...
  exchangeRateDesc: 'تحويل الأرصدة الأجنبية إلى {{base}} — 1 [عملة] = X {{base}}',
  from: 'من',
  rate: 'السعر',
  select: 'اختر',
  addRate: 'إضافة سعر',
